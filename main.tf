...
module "rgroup" {
  source          = "./modules/rgroup-N01595004"
  rgroup-name     = "N01595004-RG"
...
module "network" {
  source          = "./modules/network-N01595004"
...
module "common" {
  source          = "./modules/common-N01595004"
...
module "vmlinux" {
  source            = "./modules/vmlinux-N01595004"
  nb_count          = "3"
  linux-vm-name     = "vmlinux-N01595004"
  rgroup-name       = module.rgroup.az-rgroup-name.name
  rgroup-location   = module.rgroup.az-rgroup-location.location
...
module "vmwindows" {
  source         = "./modules/windows-N01595004"
  windows_name   = {
    n01595004-vm1 = "Standard_B1s"
    n01595004-vm2 = "Standard_B1ms"
  }
  win_nb_count     = "1"
  subnet_id        = module.network.azurerm_subnet_name.id
  rgroup-name      = module.rgroup.az-rgroup-name.name
...
module "datadisk" {
  source                   = "./modules/datadisk-N01595004"
  rgroup-name              = module.rgroup.az-rgroup-name.name
  rgroup-location          = module.rgroup.az-rgroup-location.location
...
module "loadbalancer" {
  source           = "./modules/loadbalancer-N01595004"
  rgroup-name      = module.rgroup.az-rgroup-name.name
  rgroup-location  = module.rgroup.az-rgroup-location.location
...
module "database" {
  source      = "./modules/database-N01595004"
  rgroup-name     = module.rgroup.az-rgroup-name.name
  rgroup-location = module.rgroup.az-rgroup-location.location
  depends_on = [
    module.rgroup
